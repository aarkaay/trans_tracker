...
jQuery(document).ready(function(){
	jQuery("#common_form").validate({
		...
		messages: {
			mc_name: "Please enter your country"
		},
		...
		submitHandler: function (form) {
            ...
            jQuery.ajax({
                type: "POST",
	            data: datastring,
	            url:'<?php echo base_url(); ?>/admin/master/add_country',
...
<div class="centercontent tables">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">Master Country</h1>
            <span class="pagedesc"></span>
            <ul class="hornav">
                <li class="current"><a href="#listing">Lisitng</a></li>
                <li class=""><a href="#adding">Add Country</a></li>
            </ul>
        </div><!--pageheader-->
                ...
                <table cellpadding="0" cellspacing="0" border="0" id="table1" class="stdtable stdtablecb">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $value['mc_dateadded']; ?></td>
                        </tr>
                        <?php		
							}
                    	}
               ...
               <div id="adding" class="subcontent" style="display:none ;">
                    ...
                    <form id="common_form" class="stdform" method="post" action="" novalidate="novalidate">
                    	<p>
                            ...
                            <span class="field"><input type="text" name="mc_name" id="mc_name" class="longinput"></span>
                        </p>
